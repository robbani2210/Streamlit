...
if test == "Home":
    st.subheader("streamlits")
    
    st.write(
        ""
    )
    st.write("Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perferendis, aut?")
    ...
    st.write(
            """
            kita akan membuat tutorial untuk orang-orang yang:
